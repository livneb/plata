...
from inkcliq.config.settings import ServiceEntrypoint, get_settings
from inkcliq.core.observability import configure, get_logger
...
async def _run_dashboard() -> None:
    from inkcliq.dashboard.app import app
...
async def _run_ingestion_hub() -> None:
    from inkcliq.agents.orchestrator import Orchestrator
    from inkcliq.agents.scraper.runner import Scraper
    from inkcliq.hitl.telegram_bot import TelegramBot
...
async def _run_intelligence_sandbox() -> None:
    from inkcliq.agents.graph_ingestion import GraphIngestion
    from inkcliq.agents.reviewer import Reviewer
    from inkcliq.agents.strategist import Strategist
...
async def _run_execution_vault() -> None:
    from inkcliq.agents.executor import Executor
    from inkcliq.agents.risk_manager import RiskManager
