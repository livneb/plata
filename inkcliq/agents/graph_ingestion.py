...
from inkcliq.agents.scraper.sanitizer import wrap_untrusted
from inkcliq.core.bus import Streams, publish
from inkcliq.core.db import SignalArchive, session_scope
from inkcliq.core.embeddings import embed
from inkcliq.core.graph import ensure_indexes, upsert_edge, upsert_entity, upsert_event
from inkcliq.core.llm import LLMClient
...
from inkcliq.core.ulid import new_ulid
...
class GraphIngestion(BaseAgent):
    ...
    async def handle(self, payload: dict[str, Any]) -> None:
        ...
        try:
            from inkcliq.oracle.backfill import backfill_event_async
            import asyncio
